...
Две карточки всегда: Регистрация (Красный проспект 68) и Банкет (Ресторан «Сибирь», ул. Новая Заря, 53А). Виджет Яндекс.Карт — рядом/под карточками; какой конструктор — по `full=true` (FR-03).
